...
import { Endereco } from '../crud-adm/models/endereco.models';
...
export class EnderecoService {
    ...
    findByNome(nome: string): Observable<Endereco[]> {
      return this.httpClient.get<Endereco[]>(`${this.baseUrl}/search/nome/${nome}`);
    }
